...
public class LinkedListTest {
    ...
    @Test
    public void firstElementShouldGetValueProperlyAfterRemoveEarlierFirst() {
        //given
        initializeHolderWith_3_4_5_2_1();
    ...
    @Test
    public void secondElementShouldGetValueProperlyAfterRemoveFirstElement() {
        //given
        initializeHolderWith_3_4_5_2_1();

        list.remove(0);

        assertThat(list.get(1)).isEqualTo(5L);
    }
